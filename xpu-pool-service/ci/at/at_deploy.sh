...
artgct pull 56e9a8ca9a9045a98c283f80cc958ffc ${build_version} -rn snapshot -at cloudartifact -ap deploy
...
scp ${upload_version}.${upload_arch}.zip ${execute_environment}:/data/ci/at/
