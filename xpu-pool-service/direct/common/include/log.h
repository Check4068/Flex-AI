...
namespace xpu {
extern std::string GetContainerIDFromCgroup(const std::string &cgroupPath);
extern void logFileSetContainer(const std::string &logdir, std::shared_ptr<spdlog::logger> &logger);
