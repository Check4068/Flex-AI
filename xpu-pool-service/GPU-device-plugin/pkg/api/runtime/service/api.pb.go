...
var file_api_proto_goTypes = []any{}{
	...
	(*GetAllVxpuInfoRequest)(nil),  // 2: service.GetAllVxpuInfoRequest
	(*GetAllVxpuInfoResponse)(nil), // 3: service.GetAllVxpuInfoResponse
}
var file_api_proto_depIdxs = []int32{
	...
	2, // 2: service.PidsService.GetAllVxpuInfo:input_type -> service.GetAllVxpuInfoRequest
	3, // 3: service.PidsService.GetAllVxpuInfo:output_type -> service.GetAllVxpuInfoResponse
...
func file_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch val := val.(*GetAllVxpuInfoResponse); i {
			case 0:
				return &val.state
			case 1:
				return &val.sizeCache
